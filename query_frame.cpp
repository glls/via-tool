...
static BOOL CALLBACK timecode_dialog_proc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
	...
	case WM_INITDIALOG:
		...
		SendMessage(GetDlgItem(hwnd, IDC_TIMECODE_SPIN), UDM_SETPOS, 0, (opt->current & 0x7fffffff));
	...
	case WM_COMMAND:
		...
		case IDC_TIMECODE_VIEW:
			if(HIWORD(wparam) == EN_KILLFOCUS){
				...
				SendMessage(GetDlgItem(hwnd, IDC_TIMECODE_SPIN), UDM_SETPOS, 0, (w & 0x7fffffff));
			}
			break;
		}
		break;
